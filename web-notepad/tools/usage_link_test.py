...
async def main():
    async with async_playwright() as p:
        ...
        href = await A.get_attribute('#cloneGemini', 'href')
        ok('이 메모장을 Gemini Canvas에서 만들어 보세요' in dlg and 'Canvas 미리보기에서 메모장 사용' in dlg, '앱 복제 안내 창에 Gemini Canvas 목적과 순서 포함')

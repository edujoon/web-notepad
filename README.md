...
마크다운이 섞인 글을 세 가지 방식으로 보고 편집하고 복사할 수 있는 정적 웹 메모장입니다. Claude 아티팩트에서 만든 단일 HTML 앱을 일반 브라우저와 Vercel에서도 독립적으로 실행할 수 있도록 정리했습니다.
...
`file://`로 직접 열기보다 정적 서버를 권장합니다. 첫 안내 메모는 같은 출처의 `web-notepad/USAGE.md`를 불러오기 때문입니다.
